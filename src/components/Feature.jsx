  ...
  return (
    <div className="py-lg-5 mb-31 position-relative">
      <div className="container pt-3 pt-md-5 mt-2">
        ...
        <div className="d-flex align-items-center justify-content-center pt-2 mt-1 flex-wrap gap-25">
          <a
            onClick={() => handleTabClick("tab1")}
            className={`tab_btn  font-gradient text-decoration-none fs-sm fw-semibold  lh-25 ff-sans d-flex justify-content-center align-items-center ${
          ...
          <a
            ...
            className={`tab_btn  text-decoration-none font-gradient fs-sm fw-semibold  lh-25 ff-sans d-flex justify-content-center align-items-center ${
